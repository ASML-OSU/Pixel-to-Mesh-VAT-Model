function write_CQUAD4_asy(elements,design_folder,fname)
...
for ii = 1:size(elements,1)
    ...
    cquad4 = ['CQUAD4,' num2str_integer(elements(ii,1)) ',' ...
        num2str_integer(elements(ii,2)) ',' ...
         num2str_integer(elements(ii,3)) ',' ...
          num2str_integer(elements(ii,4)) ',' ...
           num2str_integer(elements(ii,5)) ',' ...
            num2str_integer(elements(ii,6)) ',' ...
            '0,',num2str(elements(ii,7))];
    fprintf(fid102,'%s\n',cquad4);
