...
function [Amatrix,Dmatrix,Ashear,Bmatrix,Qbar_theta,ThermalExpCoeff]= ...
    LaminatedComposite_VAT_full(Mat,Stru,Laminate,layerNo,theta,zk,zk0)
format long;
...
Amatrix=(zk-zk0)*D_bend;
Bmatrix=1/2*(zk^2-zk0^2)*D_bend;
Dmatrix=1/3*(zk^3-zk0^3)*D_bend;

Ashear=Mat.kappa*(zk-zk0)*D_shear;
