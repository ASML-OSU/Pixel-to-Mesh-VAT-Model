...
for layer_num = 1:length(Layerthickness)


    % pcomp_line_dat =['        ' num2str_integer(MatID(layer_num))  num2str8(Layerthickness(layer_num))  num2str8(FiberPlyAngle(layer_num)) 'YES'];
    pcomp_line_dat =[' ,' num2str_integer(MatID(layer_num)) ',' num2str(Layerthickness(layer_num)) ','  num2str8(FiberPlyAngle(layer_num)) ',YES'];
    fprintf(fid101,'%s\n',pcomp_line_dat);
