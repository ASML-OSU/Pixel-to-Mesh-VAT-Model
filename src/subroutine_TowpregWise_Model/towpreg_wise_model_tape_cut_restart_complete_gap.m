...
wt0 = 3.175/1000*2;%12.7e-3;3.175/1000;

number_of_tapes = 8;32;

tows_width = number_of_tapes*wt0;
...
for lamina_layer = 1:laminate_layers
    ...
    if abs(T0-T1)<=deg2rad(0.2)
        ...
        shiftdistance = tows_width*shiftfactor;
        %%
        ...
        tows_number = round(Plate.width/(tows_width))-1+4;
        ...
        for tows_no = 2:tows_number+1
            ...
            for kk = 1:size(tapecenterlines,3)
                ...
                % if iseven(tows_no)
                %     patch_plot( tape_elements,edges_points_all ,5,'tape');axis image;
                % else
                %
                %     patch_plot( tape_elements,edges_points_all ,5,'tape3');axis image;
                % end
